...
public class Constants {
    ...
    public static final String PRIVATE_LISTENING_URL = "https://github.com/wseemann/RoMote-PrivateListening/releases/download/v1.0.18/RoMote-PrivateListening-1.0.18.apk";
}
